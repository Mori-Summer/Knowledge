...
title: 协程认知手册：以 C++20 为例，从概念到可操作模型
concept: C++20 coroutine
...
source_basis:
  ...
  - personal_synthesis
time_context: review_when_cpp_coroutine_tooling_or_runtime_practice_changes
