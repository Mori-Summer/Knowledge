...
time_context: repository_practice_checked_2026_04_08_and_skill_paths_and_entry_behavior_rechecked_2026_06_16
...
### 8.1 `bmad-agent-tech-writer`：skill 作为 agent 入口资产

[bmad-agent-tech-writer/SKILL.md](../../.agents/skills/bmad-agent-tech-writer/SKILL.md) 把 persona、激活顺序、配置加载、菜单分发和输出语言约束组织在同一个入口资产中。
这说明一个 skill 可以不只是短触发器，也可以直接承载 agent 角色、菜单和执行规则。

### 8.2 `bmad-help`：skill 作为路由与工作流入口

[bmad-help/SKILL.md](../../.agents/skills/bmad-help/SKILL.md) 会读取 [_bmad/_config/bmad-help.csv](../../_bmad/_config/bmad-help.csv) 这类 catalog/config 信息，判断当前 BMad 工作流位置并推荐下一步。
这说明 skill 不一定直接长成一大段提示词，它也可以是“把你带进正确流程”的路由入口层资产。

### 8.3 `bmad-quick-dev`：skill 作为完整工作方法包

[bmad-quick-dev/SKILL.md](../../.agents/skills/bmad-quick-dev/SKILL.md) 使用 step-file 架构，从 [step-01-clarify-and-route.md](../../.agents/skills/bmad-quick-dev/step-01-clarify-and-route.md) 开始，再按任务路径进入 planning、implementation、review 或 one-shot 步骤。
...
本节涉及当前实践判断，外部概念时间锚点为 `2026-04-08`；当前仓库中的 skill 路径与入口行为已在 `2026-06-16` 补充复核。
...
- [_bmad/_config/bmad-help.csv](../../_bmad/_config/bmad-help.csv)
- [bmad-quick-dev/SKILL.md](../../.agents/skills/bmad-quick-dev/SKILL.md)
- [bmad-quick-dev/step-01-clarify-and-route.md](../../.agents/skills/bmad-quick-dev/step-01-clarify-and-route.md)
